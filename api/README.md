...
**Cause:** A local PostgreSQL instance is running on port 5432, intercepting connections.
...
4. **Test endpoints**
   ...
   * Use [http://localhost:8000/api/docs](http://localhost:8000/api/docs) for interactive testing
   * Or use curl/Postman
